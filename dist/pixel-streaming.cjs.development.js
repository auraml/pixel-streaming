...
var scripts = {
  ...
  "build-all":
    "yarn symlink && cd ../library && npm run build && cd ../ui-library && npm run build-all",
}
var husky = {
  hooks: {
...
var project = {
  ...
  urls: {
    ...
    signalingServer:
      "https://github.com/markolofsen/metaeditor/releases/tag/signaling-server",
...
function _checkPackageVersion() {
  _checkPackageVersion = _asyncToGenerator(
...
function _checkLicenseKey() {
  _checkLicenseKey = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
      var url, v
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1)
...
var actions = function actions() {
  ...
  var cls = new /*#__PURE__*/ ((function () {
    ...
    _proto.checkVersion = /*#__PURE__*/ (function () {
      var _checkVersion = _asyncToGenerator(
        /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
          var packageVersion
    ...
    _createClass(_class, [
      ...
      },
      {
        ...
        get: function get() {
          ...
          return (_state$licenseData = state.licenseData) == null
            ? void 0
            : _state$licenseData.is_valid
        },
      },
      {
        ...
        get: function get() {
          ...
          if (!state.licenseData) return false
          return (
            ((_state$licenseData2 = state.licenseData) == null
              ? void 0
              : _state$licenseData2.is_valid) ||
            ((_state$licenseData3 = state.licenseData) == null
              ? void 0
              : _state$licenseData3.is_exclusion)
          )
        },
      },
    ])
...
function Reducer$1(state, action) {
  ...
  if (type === KEYS$1.UPDATE) {
    ...
    state.playerConfig.psConfig = _extends(
      {},
  ...
  var cls = new /*#__PURE__*/ ((function () {
    ...
    _createClass(_class, [
      ...
      },
      {
        key: "isWebrtcError",
        get: function get() {
          return ["failed", "disconnected", "disconnectedRestart"].includes(
            state.webrtcStatus
          )
        },
      },
...
function ContextProvider(props) {
  return React__default.createElement(
    Provider,
    null,
    React__default.createElement(Provider$1, null, props.children)
  )
}
    ...
    _proto.add = function add(type, payload, options) {
      ...
      if (showNotification) {
        toaster.push(
          ...
          {
            placement:
              (options == null ? void 0 : options.placement) || "bottomEnd",
...
function useStreamActions() {
  ...
  var cls = new /*#__PURE__*/ ((function () {
    ...
    _proto.play = function play() {
      ...
      ;(_window$player$stream = window.player.stream) == null
        ? void 0
        : _window$player$stream.play()
    }
    _proto.reconnect = function reconnect() {
      var _window$player$stream2
      ;(_window$player$stream2 = window.player.stream) == null
        ? void 0
        : _window$player$stream2.reconnect()
    }
    _proto.disconnect = function disconnect() {
      var _window$player$stream3
      ;(_window$player$stream3 = window.player.stream) == null
        ? void 0
        : _window$player$stream3.disconnect()
    }
  ...
  var cls = new /*#__PURE__*/ ((function () {
    ...
    _createClass(_class, [
      ...
      },
      {
        ...
        get: function get() {
          return (
            streamContext.state.webrtcMessage ||
            streamContext.state.webrtcStatus
          )
        },
      },
    ])
...
function useStreamEvents() {
  ...
  // })
  useEventListener(
    stream == null ? void 0 : stream.videoElementParent,
    "click",
    function () {
  ...
  React.useEffect(
    function () {
      ...
      if ((_window = window) != null && _window.metaeditor) {
        window.metaeditor.emitResponse.addResponseEventListener(
          "handle_responses",
      ...
      return function () {
        ...
        if ((_window2 = window) != null && _window2.metaeditor) {
          window.metaeditor.emitResponse.removeResponseEventListener(
            "handle_responses"
          )
        }
      }
...
var WebrtcError = function WebrtcError() {
  ...
  return React.createElement(
    ...
    React.createElement("h5", null, preloader.webrtcErrorHeader),
    React.createElement(
      rsuite.Button,
      {
...
function PreloaderDialog() {
  ...
  return React.createElement(
    ...
    preloader.webrtcErrorHeader
      ? React.createElement(WebrtcError, null)
...
var CustomDrawer = /*#__PURE__*/ React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        rsuite.Drawer.Header,
        null,
        React.createElement(rsuite.Drawer.Title, null, title)
      ),
      React.createElement(
        rsuite.Drawer.Body,
        {
...
function DrawerContainer() {
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      null,
      React.createElement("h6", null, "Current config"),
      React.createElement(JsonView, {
        data: streamContext.state,
        expanded: true,
      }),
      React.createElement(rsuite.Divider, null),
      React.createElement("h6", null, "Commands history"),
      React.createElement(JsonView, {
        data: streamContext.commandsList,
      }),
      React.createElement(rsuite.Divider, null),
      React.createElement("h6", null, "Responses history"),
      React.createElement(JsonView, {
...
function UiButton() {
  ...
  return React.createElement(
    React.Fragment,
    null,
    React.createElement(DrawerInfo, {
      ref: refDrawerInfo,
    }),
    React.createElement(
      "button",
...
function Toolbar(_ref) {
   ...
   */
  var nodeUiFeatures =
    typeof document !== "undefined" && document.getElementById("uiFeatures")
  var nodePlayerUI =
    typeof document !== "undefined" && document.getElementById("playerUI")
  var nodeControls =
    typeof document !== "undefined" && document.getElementById("controls")
  /***
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(PackageUpdate, null),
...
var PixelStreamingApplicationStyles =
  /*#__PURE__*/ new metaeditor4Ui.PixelStreamingApplicationStyle()
...
var PlayerComponent = /*#__PURE__*/ React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(
    "div",
    null,
    React.createElement(PreloaderDialog, null),
