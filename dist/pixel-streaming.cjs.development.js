...
var CheckRoundIcon = _interopDefault(require('@rsuite/icons/CheckRound'));
var ToolsIcon = _interopDefault(require('@rsuite/icons/Tools'));
...
var actions$1 = function actions() {
  ...
  // refs
  var refStreamApp = React.useRef(null);
  // classes
  var cls = new ( /*#__PURE__*/function () {
    function _class() {}
    var _proto = _class.prototype;
...
var JsonView = function JsonView(props) {
  return React.createElement(reactJsonTree.JSONTree, {
    invertTheme: false,
...
function useSave() {
  ...
  var cls = new ( /*#__PURE__*/function () {
    ...
    _proto.add = function add(type, payload, options) {
      ...
      if (showNotification) {
        toaster.push(React.createElement(rsuite.Notification, {
          type: "success",
          header: "Command",
          closable: true
...
var Preloader = function Preloader() {
  ...
  if (preloader.isWebrtcConnected) {
    return React.createElement(PlayOutlineIcon, {
  ...
  }), React.createElement("small", null, preloader.connectionHeader));
};
var WebrtcError = function WebrtcError() {
  ...
  }, React.createElement("h5", null, preloader.webrtcErrorHeader), React.createElement(rsuite.Button, {
...
function PreloaderDialog() {
  ...
  }, preloader.webrtcErrorHeader ? React.createElement(WebrtcError, null) : React.createElement(Preloader, null));
}
...
function Appbar() {
  ...
  return React.createElement(rsuite.Navbar, {
    appearance: "subtle"
  }, React.createElement(rsuite.Navbar.Brand, {
    as: "a",
    href: project.urls.main,
    target: "_blank"
  }, project.name, " ", isLicenseValid && 'Pro'), React.createElement(rsuite.Nav, {
    onSelect: function onSelect() {},
    activeKey: undefined
  }, React.createElement(rsuite.Nav.Menu, {
    title: "Tools"
  }, toolsMenu.map(function (item, index) {
    return React.createElement(rsuite.Nav.Item, {
      key: index,
  ...
  }))), media.up.sm && !isLicenseValid && React.createElement(rsuite.Nav, {
    pullRight: true
  }, React.createElement(rsuite.Nav.Item, {
    as: "a",
    href: project.urls.buy,
    target: "_blank"
  }, React.createElement(rsuite.Button, {
    color: "green",
    appearance: "primary",
    startIcon: React.createElement(CheckRoundIcon, null)
  }, "Buy Pro"))));
}

var _excluded = ["title", "children", "contentPadding", "onClose"];
var CustomDrawer = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(rsuite.Drawer, Object.assign({}, props, {
    size: drawerSize,
    open: open,
  ...
  }), React.createElement(rsuite.Drawer.Header, null, React.createElement(rsuite.Drawer.Title, null, title)), React.createElement(rsuite.Drawer.Body, {
    style: {
...
function DrawerContainer() {
  ...
  var streamActions = useStreamActions();
  var responseSave = useResponseSave();
  return React.createElement(React.Fragment, null, React.createElement("div", null, React.createElement("h6", null, "Current config"), React.createElement(JsonView, {
    data: streamContext.state,
    expanded: true
  }), React.createElement(rsuite.Divider, null), React.createElement("h6", null, "Commands history"), React.createElement(JsonView, {
    data: streamContext.commandsList
  }), React.createElement(rsuite.Divider, null), React.createElement("h6", null, "Responses history"), React.createElement(JsonView, {
    data: streamContext.responsesList
  }), React.createElement(rsuite.Divider, null), React.createElement(rsuite.Stack, {
    direction: 'column',
    spacing: 5,
  ...
  }, "Reset resolution"), React.createElement(rsuite.Button, {
    onClick: function onClick() {
...
var DrawerInfo = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return React.createElement(CustomDrawer, {
    backdrop: true,
    contentPadding: 20,
    placement: 'right',
    title: "Tools Panel",
...
function UiButton() {
  // refs
  var refDrawerInfo = React.useRef(null);
  return React.createElement(React.Fragment, null, React.createElement(DrawerInfo, {
    ref: refDrawerInfo
...
function Toolbar(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(reactPortal.Portal, {
    node: nodePlayerUI
  }, React.createElement("div", {
    className: styles.appbar,
    ref: ref
  }, React.createElement(PackageUpdate, null), React.createElement(Appbar, null))), React.createElement(reactPortal.Portal, {
    node: nodeControls
...
var PixelStreamingApplicationStyles = /*#__PURE__*/new metaeditor4Ui.PixelStreamingApplicationStyle();
...
var PlayerComponent = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
  ...
  return React.createElement("div", null, React.createElement(PreloaderDialog, null), React.createElement(Toolbar, {
    show: showToolbar
  }), React.createElement("div", {
    ref: refRoot,
    className: styles.rootDiv
  }), children ? React.createElement(Container, null, children) : '');
});

var RootComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  // states
  var _React$useState = React.useState(false),
  ...
  return React.createElement(rsuite.CustomProvider, {
    theme: "dark"
  }, React.createElement(PlayerComponent, Object.assign({}, props, {
    ref: ref
  })));
});
...
exports.Hooks = Hooks;
exports.MetaEditor = RootComponent;
exports.MetaProvider = ContextProvider;
