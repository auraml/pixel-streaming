...
var React = require("react"),
  ...
  rsuite = require("rsuite"),
  moment = _interopDefault(require("moment")),
  uuid = _interopDefault(require("short-uuid")),
  reactJsonTree = require("react-json-tree"),
  reactJss = require("react-jss"),
  metaeditor4UeAuraML = require("metaeditor4-ue-auraml"),
  metaeditor4Ui = require("metaeditor4-ui"),
  SpinnerIcon = _interopDefault(require("@rsuite/icons/legacy/Spinner")),
  PlayOutlineIcon = _interopDefault(require("@rsuite/icons/PlayOutline")),
  reactPortal = require("react-portal"),
  useResizeObserver = _interopDefault(require("use-resize-observer")),
  CheckRoundIcon = _interopDefault(require("@rsuite/icons/CheckRound")),
  ToolsIcon = _interopDefault(require("@rsuite/icons/Tools"))
...
var initialState = {
    packageVersion: { latest: null, current: null, needUpdate: !1 },
    showPreloader: !0,
    licenseData: null,
  },
  ...
  bugs = { url: "https://github.com/markolofsen/metaeditor/issues" },
  keywords = [
    "reactjs",
    "node",
    "typescript",
  ...
  module$1 = "dist/index.esm.js",
  peerDependencies = { react: "^18.1.0", rsuite: "^5.28.1" },
  dependencies = {
...
function _checkPackageVersion() {
  return (_checkPackageVersion = _asyncToGenerator(
                    ...
                    .then(function (res) {
                      try {
                        var latest = res["dist-tags"].latest,
                          ...
                          needUpdate = semver.gt(latest, current)
                        resolve({
                          latest: latest,
                          current: current,
                        ...
                        console.error("Can't parse npm data"), resolve(null)
                      }
                    })
                    .catch(function (err) {
                      console.error("Can't check package version"), resolve(!1)
                    })
                })
              )
            case 3:
              return (v = _context.sent), _context.abrupt("return", v)
            case 5:
            case "end":
...
function _checkLicenseKey() {
  return (_checkLicenseKey = _asyncToGenerator(
    _regeneratorRuntime().mark(function _callee() {
      var url, v
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        for (;;)
            ...
            case 0:
              return (
                ...
                new Promise(function (resolve, reject) {
                  ...
                  project.license.excludes.includes(host)
                    ? resolve({ is_exclusion: !0, is_valid: !1 })
                    : fetch(url, {
                        method: "POST",
                        headers: {
                        ...
                        .then(function (res) {
                          resolve({ is_exclusion: !1, is_valid: res.is_valid })
                        })
                        .catch(function (err) {
                          console.error("Can't check license"),
                            resolve({ is_exclusion: !1, is_valid: !0 })
                        })
                })
              )
            case 3:
...
var actions = function actions() {
    ...
    return new ((function () {
      ...
      return (
        (_proto.dispatch = function dispatch(payload) {
          _dispatch({ type: KEYS.UPDATE, payload: payload })
        }),
        (_proto.checkVersion = (function () {
              ...
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  for (;;)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        return (_context.next = 2), checkPackageVersion()
                      case 2:
                        ;(packageVersion = _context.sent),
                          this.dispatch({ packageVersion: packageVersion })
                      case 4:
                      case "end":
                        return _context.stop()
                    }
                ...
                function _callee2$(_context2) {
                  for (;;)
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        return (_context2.next = 2), checkLicenseKey()
                      case 2:
                        ;(licenseData = _context2.sent),
                          this.dispatch({ licenseData: licenseData })
                      case 4:
                      case "end":
        ...
        _createClass(_class, [
          ...
          },
          {
            ...
            get: function get() {
              ...
              return (
                !!state.licenseData &&
                (null == (_state$licenseData = state.licenseData)
                  ? void 0
          ...
          },
          {
            ...
            get: function get() {
              ...
              return (
                !!state.licenseData &&
                ((null == (_state$licenseData2 = state.licenseData)
                  ? void 0
                  : _state$licenseData2.is_valid) ||
                  (null == (_state$licenseData3 = state.licenseData)
                    ? void 0
  ...
  useGlobalContext = function useGlobalContext() {
  ...
  KEYS$1 = { UPDATE: "UPDATE", UPDATE_PS_CONFIG_KEY: "UPDATE_PS_CONFIG_KEY" }
function Reducer$1(state, action) {
  var type = action.type,
    anValue = action.payload
  return type === KEYS$1.UPDATE
    ? _extends({}, state, anValue)
...
var initialState$1 = {
  ...
  actions$1 = function actions() {
    var _React$useReducer = React.useReducer(Reducer$1, initialState$1),
      ...
      refStreamApp = React.useRef(null),
      cls
    return new ((function () {
      function _class() {}
      var _proto = _class.prototype
      return (
        (_proto.dispatch = function dispatch(payload) {
          _dispatch({ type: KEYS$1.UPDATE, payload: payload })
        }),
        (_proto.dispatchPsConfig = function dispatchPsConfig(payload) {
          _dispatch({ type: KEYS$1.UPDATE_PS_CONFIG_KEY, payload: payload })
        }),
        ...
        (_proto.setFreezeFrame = function setFreezeFrame(freezeFrame) {
          this.dispatch({ freezeFrame: freezeFrame })
        }),
        ...
        (_proto.updateConfig = function updateConfig(playerConfig) {
          this.dispatch({ playerConfig: playerConfig })
        }),
        ...
        _createClass(_class, [
          ...
          },
          {
            key: "isStreamActive",
            get: function get() {
              return "play" === state.streamStatus
            },
          },
          {
            key: "isWebrtcConnected",
            get: function get() {
              return "connected" === state.webrtcStatus
            },
          },
          {
            key: "isWebrtcError",
  ...
  useStreamContext = function useStreamContext() {
    return React.useContext(Context$1)
  },
  Provider$1 = function Provider(props) {
...
function useSave() {
  var streamContext = useStreamContext(),
    toaster = rsuite.useToaster(),
    cls
  return new ((function () {
    function _class() {}
    var _proto
    return (
      (_class.prototype.add = function add(type, payload, options) {
        var newPayload = {
            type: type,
            uuid: uuid.generate(),
        ...
        streamContext.addCommand(newPayload),
          "off" !== (debugMode = streamContext.state.playerConfig.debugMode) &&
            !!["on", "commands"].includes(debugMode) &&
            ((null == options ? void 0 : options.debug) || !0) &&
            toaster.push(
              React.createElement(
                rsuite.Notification,
                { type: "success", header: "Command", closable: !0 },
              ...
              {
                placement:
                  (null == options ? void 0 : options.placement) || "bottomEnd",
                duration: (null == options ? void 0 : options.duration) || 2e3,
              }
            )
      }),
      _class
  ...
  return new ((function () {
    ...
    return (
      (_proto.play = function play() {
        ...
        null == (_window$player$stream = window.player.stream) ||
          _window$player$stream.play()
      }),
      (_proto.reconnect = function reconnect() {
        var _window$player$stream2
        null == (_window$player$stream2 = window.player.stream) ||
          _window$player$stream2.reconnect()
      }),
      (_proto.disconnect = function disconnect() {
        var _window$player$stream3
        null == (_window$player$stream3 = window.player.stream) ||
          _window$player$stream3.disconnect()
      }),
      (_proto.emitUi = function emitUi(payload, options) {
        save.add("ui", payload, options),
          streamContext.isStreamActive
            ? window.metaeditor && window.metaeditor.emitUIInteraction(payload)
            : console.error(
      ...
      (_proto.emitSys = function emitSys(payload, options) {
        save.add("sys", payload, options),
          streamContext.isStreamActive
            ? window.metaeditor && window.metaeditor.emitCommand(payload)
            : console.error(
                "Stream is not active. Can not emit system command."
              )
      }),
...
function usePreloader() {
  var globalContext = useGlobalContext(),
    ...
    streamActions = useStreamActions(),
    cls
  return new ((function () {
    function _class() {}
    var _proto = _class.prototype
    return (
      ...
      _createClass(_class, [
        ...
        },
        {
          ...
          get: function get() {
            return streamContext.isWebrtcError
...
function useEventListener(element, eventName, handler) {
  ...
  React.useEffect(
    function () {
      handler && (savedHandler.current = handler)
    },
    [handler]
  ),
    React.useEffect(
...
function useStreamEvents() {
  var streamContext = useStreamContext(),
    player =
      "undefined" != typeof window && window.player ? window.player : null,
    stream = null == player ? void 0 : player.stream
  useEventListener(stream, "webRtcSdp", function () {
    ...
    useEventListener(stream, "webRtcDisconnected", function (_ref) {
      ...
      0 == _ref$data.showActionOrErrorOnDisconnect
    ...
    useEventListener(
      null == stream ? void 0 : stream.videoElementParent,
      "click",
      function () {
        "connected" == streamContext.state.webrtcStatus &&
          "play" !== streamContext.state.streamStatus &&
  ...
  return new ((function () {
    ...
    return (
      (_proto.handler = function handler(data) {
        var event = new CustomEvent("ue_response", { detail: data })
        document.dispatchEvent(event)
      }),
      (_proto.add = function add(payload) {
        var newPayload = { date: moment.utc().format(), payload: payload },
          showNotification,
          debugMode
        streamContext.addResponse(newPayload),
          "off" !== (debugMode = streamContext.state.playerConfig.debugMode) &&
            !!["on", "responses"].includes(debugMode) &&
            toaster.push(
              React.createElement(
                rsuite.Notification,
                { type: "info", header: "Response", closable: !0 },
                React.createElement(JsonView, {
                  data: newPayload,
                  expanded: !0,
                })
              ),
              { placement: "bottomEnd", duration: 3e3 }
            )
      }),
      _class
    )
...
function useStreamResponses() {
  ...
  React.useEffect(
    ...
    [null == (_window3 = window) ? void 0 : _window3.metaeditor]
  )
}
var watermark = new ((function () {
  ...
  return (
    ...
    (_proto.stop = function stop() {
      var _this$node
      clearInterval(watermarkTimer),
        null == (_this$node = this.node) || _this$node.remove()
    }),
...
function useWatermark() {
  var globalContext = useGlobalContext(),
    streamContext = useStreamContext(),
    licenseData = globalContext.state.licenseData,
    configLoaded = !!streamContext.state.playerConfig
  React.useEffect(function () {
    return function () {
      watermark.stop()
    }
    ...
    React.useEffect(
      function () {
        globalContext.isLicenseActivated ? watermark.stop() : watermark.start()
      },
      [licenseData]
    ),
    React.useEffect(
      function () {
        configLoaded && globalContext.checkApiKey()
      },
      [configLoaded]
    )
}
var useStyles = reactJss.createUseStyles({
    ...
    webrtcError: {
      ...
      flexDirection: "column",
      alignItems: "center",
      "& > h5": { textAlign: "center", marginBottom: "1rem" },
    },
    preloader: {
      display: "flex",
      flexDirection: "column",
  ...
  Preloader = function Preloader() {
    ...
    return preloader.isWebrtcConnected
      ? React.createElement(PlayOutlineIcon, {
  ...
  WebrtcError = function WebrtcError() {
    var styles = useStyles(),
      preloader = usePreloader()
    return React.createElement(
      "div",
      ...
      React.createElement(
        rsuite.Button,
        { onClick: preloader.connect, appearance: "ghost" },
        "Restart"
      )
    )
  }
function PreloaderDialog() {
  var styles = useStyles(),
    ...
    preloader = usePreloader()
  return globalContext.state.showPreloader
    ? preloader.isWebrtcConnected
      ? null
      : React.createElement(
          "div",
...
var useMedia = function useMedia() {
  var smUp, smDown
  return {
    up: { sm: useMediaQuery("(min-width: 768px)") },
    down: { sm: useMediaQuery("(max-width: 768px)") },
  }
}
function useMediaQuery(query) {
  var getMatches = function getMatches(query) {
      return "undefined" != typeof window && window.matchMedia(query).matches
    },
    _useState = React.useState(getMatches(query)),
    matches = _useState[0],
...
function Appbar() {
  var globalContext = useGlobalContext(),
    media = useMedia(),
    streamActions = useStreamActions(),
    isLicenseValid = globalContext.isLicenseValid,
    toolsMenu = [
      {
    ...
    helpMenu =
      ((res = [
        { title: "Online Player", href: project.urls.onlinePlayer },
        { title: "Signaling Server", href: project.urls.signalingServer },
        { title: "Documentation", href: project.urls.docs },
        { title: "Support", href: project.urls.support },
      ]),
      media.down.sm &&
        !isLicenseValid &&
        (res = [
          { title: project.name + " Pro", href: project.urls.buy },
        ].concat(res)),
      res),
    res
  return React.createElement(
    ...
    React.createElement(
      rsuite.Navbar.Brand,
      { as: "a", href: project.urls.main, target: "_blank" },
      project.name,
      " ",
      isLicenseValid && "Pro"
    ),
    React.createElement(
      rsuite.Nav,
      { onSelect: function onSelect() {}, activeKey: void 0 },
      React.createElement(
        rsuite.Nav.Menu,
        { title: "Tools" },
      ...
      React.createElement(
        ...
        helpMenu.map(function (item, index) {
          return React.createElement(
            rsuite.Nav.Item,
            { key: index, as: "a", href: item.href, target: "_blank" },
            item.title
          )
        })
      )
    ...
    media.up.sm &&
      ...
      React.createElement(
        ...
        React.createElement(
          rsuite.Nav.Item,
          { as: "a", href: project.urls.buy, target: "_blank" },
          React.createElement(
            rsuite.Button,
            {
              color: "green",
...
var _excluded = ["title", "children", "contentPadding", "onClose"],
  CustomDrawer = React.forwardRef(function (_ref, ref) {
...
function DrawerContainer() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(JsonView, { data: streamContext.commandsList }),
      React.createElement(rsuite.Divider, null),
      React.createElement("h6", null, "Responses history"),
      React.createElement(JsonView, { data: streamContext.responsesList }),
      React.createElement(rsuite.Divider, null),
      React.createElement(
        rsuite.Stack,
        { direction: "column", spacing: 5, alignItems: "flex-start" },
        React.createElement(
          rsuite.Button,
          {
            onClick: function onClick() {
...
var DrawerInfo = React.forwardRef(function (props, ref) {
  var refDrawer = React.useRef(null)
  return (
    React.useImperativeHandle(ref, function () {
      return {
        open: function open() {
          null == refDrawer || refDrawer.current.open()
        },
        close: function close() {
          null == refDrawer || refDrawer.current.close()
        },
      }
    }),
    React.createElement(
...
function UiButton() {
  ...
  return React.createElement(
    React.Fragment,
    null,
    React.createElement(DrawerInfo, { ref: refDrawerInfo }),
    React.createElement(
      "button",
      {
        onClick: function onClick() {
      ...
      React.createElement(ToolsIcon, { style: { fontSize: 24, lineHeight: 0 } })
    )
  )
}
var useStyles$1 = reactJss.createUseStyles({
  message: {
    ...
    "&:hover": { backgroundColor: "var(--rs-orange-800)" },
  },
})
function PackageUpdate() {
  var globalContext = useGlobalContext(),
    styles = useStyles$1(),
    pkg = globalContext.state.packageVersion,
    needUpdate
...
function Toolbar(_ref) {
  var show = _ref.show,
    styles = useStyles$2(),
    _useResizeObserver = useResizeObserver({ box: "border-box" }),
    ...
    function () {
      if (height) {
        ...
        var el = document.getElementById("controls"),
          controlsHeight = el.clientHeight
        if (el) {
  ...
  var nodeUiFeatures =
      "undefined" != typeof document && document.getElementById("uiFeatures"),
    nodePlayerUI =
      "undefined" != typeof document && document.getElementById("playerUI"),
    nodeControls =
      "undefined" != typeof document && document.getElementById("controls")
  return (
    React.useEffect(
      function () {
        nodeUiFeatures &&
    ...
    show && nodePlayerUI
      ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: styles.appbar, ref: ref },
...
var _excluded$1 = ["children"],
  PixelStreamingApplicationStyles =
    new metaeditor4Ui.PixelStreamingApplicationStyle()
...
var useStyles$4 = reactJss.createUseStyles({
    "@global": {
      ...
      "#playOverlay": { display: "none" },
      "#infoOverlay": { display: "none" },
      "#disconnectOverlay": { display: "none" },
      "#errorOverlay": { display: "none" },
      "#uiFeatures": { visibility: "hidden" },
      '[data-click="true"]': { pointerEvents: "all" },
      '[data-click="false"]': { pointerEvents: "none" },
    },
    rootDiv: {
      zIndex: 0,
      position: "fixed",
  ...
  PlayerComponent = React.forwardRef(function (_ref, ref) {
    var children = _ref.children,
    ...
    useWindowSize(),
      ...
      React.useEffect(function () {
        metaeditor4UeAuraML.Logger.SetLoggerVerbosity(0),
          isReady ||
            (setIsReady(!0),
            props.showToolbar && globalContext.checkVersion(),
            init())
      }, [])
    var init = function init() {
      ...
      var initialSettings = {
        ...
        config = new metaeditor4UeAuraML.Config({
          useUrlParams: !0,
          initialSettings: initialSettings,
        }),
        stream = new metaeditor4UeAuraML.PixelStreaming(config),
        application = new metaeditor4Ui.Application({ stream: stream })
      refRoot.current &&
        !refRoot.current.textContent &&
        (streamContext.setRefStream(application),
        (window.player = application),
        refRoot.current.appendChild(application.rootElement),
        "function" == typeof props.onLoad && props.onLoad())
    }
    return (
      React.useImperativeHandle(ref, function () {
        return { init: init }
      ...
      React.createElement(
        ...
        React.createElement(Toolbar, { show: showToolbar }),
        React.createElement("div", { ref: refRoot, className: styles.rootDiv }),
        children ? React.createElement(Container, null, children) : ""
      )
    )
  }),
  RootComponent = React.forwardRef(function (props, ref) {
  ...
  Context$2 = { global: useGlobalContext, stream: useStreamContext },
  Hooks = {
